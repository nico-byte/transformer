...
if not os.path.exists('./tokenizers/unigram'):
    os.makedirs('./tokenizers/unigram')
        
de_tokenizer.save("./tokenizers/unigram/cased-de.json")
en_tokenizer.save("./tokenizers/unigram/cased-en.json")

de_tokenizer = Tokenizer.from_file("./tokenizers/unigram/cased-de.json")
en_tokenizer = Tokenizer.from_file("./tokenizers/unigram/cased-en.json")
